...
$email_subject = "Contact du site web par : $name";
$email_body = "Vous avez reçu un nouveau message de la page de contact du site des RHM.\n\n"."Voici les détails:\n\nName: $name\n\nEmail: $email_address\n\nPhone: $phone\n\nMessage:\n$message";
$headers = "Contact du site RHM\n"; // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
