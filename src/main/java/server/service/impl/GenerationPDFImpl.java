 ...
 */
public class GenerationPDFImpl {
//    String tableRow;
//    String rowFilePath;
...
//    String InvoiceClientPhone = "clzientPhone";
...
//    public GenerationPDFImpl(String upperSource, String rowSource, String lowerSource, String destination, Client c, List<Booking> list){
...
//    }
//
//    private void convertStringToPdf(String s) throws DocumentException {
...
//            Client al = new Client("Ondzounga","Alvin","ondzoungabruce@hotmail.fr","92190","France","Meudon","25/03/1994","0643329404","35 route de vaugirard");
//            Client max = new Client("Mollard","Maxime","maxime.mollard75@hotmail.fr","75015","France","Paris","25/03/1994","0643329404","35 route de vaugirard");
//            Client kev = new Client("Vivor","Kévin","KevOR@hotmail.fr","93190","France","Val de fontenay","25/03/1994","0643329404","35 route de vaugirard");
//
//            Booking reservation = new Booking("Chambre Double",1,"13/11/2017","23/12/2017",100000);
//            Booking r2 = new Booking("Chambre Double",3,"23/11/2017","26/12/2017",100000);
//            Booking r3 = new Booking("Suite Junior",2,"15/11/2017","23/12/2017",150000);
//            Booking r4 = new Booking("Suite Executive",5,"02/11/2017","23/12/2017",200000);
//
//            List<Booking> listDeRes = new ArrayList<Booking>();
...
//            GenerationPDFImpl C = new GenerationPDFImpl(upperTemplate,rowTemplate,lowerTemplate,pdfFilePath,al,listDeRes);
//
//    }
}